...
<body>
    ...
    <!-- HALAMAN 3: Hasil Perangkingan, Kesimpulan, dan Footer -->
    <div class="page-break"></div>
    ...
    <div class="section-container">
        ...
        <div class="conclusion-box">
            @if (count($perhitungan->hasil_perangkingan) > 0)
                @php
                    $terbaik = collect($perhitungan->hasil_perangkingan)->where('rank', 1)->first();
                @endphp
                @if($terbaik)
