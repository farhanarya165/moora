...
<div class="dashboard-header">
    ...
    <p class="dashboard-subtitle">Kelola sistem SPK karyawan terbaik dengan mudah dan efisien</p>
</div>
        ...
        <div class="content-card">
            <div class="content-card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.perhitungan.index') }}" class="btn btn-enhanced btn-primary">
                    ...
                    <table class="table enhanced-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center me-2" style="width: 35px; height: 35px; font-size: 0.8rem;">
                                            {{ strtoupper(substr($perhitungan->user->name, 0, 2)) }}
                                        </div>
                                ...
                                <td>
                                    <a href="{{ route('admin.perhitungan.show', $perhitungan->id) }}" 
        ...
        <div class="content-card">
            ...
            <div class="content-card-body">
                <div class="about-section">
                    <p class="about-text">
                        <strong>Sistem Pendukung Keputusan (SPK)</strong> pemilihan karyawan terbaik menggunakan metode 
                    ...
                    <div class="steps-list">
                        ...
                        <ol>
                            ...
                            <li><i class="fas fa-calculator me-2 text-danger"></i>Lakukan perhitungan dengan metode MOORA</li>
                        </ol>
                    </div>
                </div>
            </div>
