    ...
    <div class="card-body">
        <form action="{{ route('admin.alternatif.update', $alternatif->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kode') is-invalid @enderror" id="kode" name="kode" value="{{ old('kode', $alternatif->kode) }}" required>
                @error('kode')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $alternatif->nama) }}" required>
                @error('nama')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="{{ route('admin.alternatif.index') }}" class="btn btn-secondary me-md-2">Batal</a>
