        ...
        <form action="{{ route('admin.penilaian.update', $alternatif->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('nilai.' . $kriteria->id) is-invalid @enderror"
                    ...
                    <option value="{{ $subKriteria->nilai }}" {{ old('nilai.' . $kriteria->id, $nilai) == $subKriteria->nilai ? 'selected' : '' }}>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="{{ route('admin.penilaian.index') }}" class="btn btn-secondary me-md-2">Batal</a>
