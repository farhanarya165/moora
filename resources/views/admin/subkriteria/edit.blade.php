    ...
    <div class="card-body">
        <form action="{{ route('admin.subkriteria.update', $subKriteria->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" value="{{ old('keterangan', $subKriteria->keterangan) }}" required>
                @error('keterangan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('nilai') is-invalid @enderror" id="nilai" name="nilai" value="{{ old('nilai', $subKriteria->nilai) }}" required>
                @error('nilai')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="{{ route('admin.subkriteria.index') }}" class="btn btn-secondary me-md-2">Batal</a>
