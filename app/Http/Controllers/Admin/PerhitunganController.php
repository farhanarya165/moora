...
class PerhitunganController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.perhitungan.index', compact('hasilPerhitungans'));
    }
    ...
    public function show($id)
    {
        ...
        // ✅ ADMIN BISA LIHAT SEMUA PERHITUNGAN
        // Tidak perlu cek ownership karena ini admin controller
        
        return view('admin.perhitungan.detail', compact('hasil'));
    }
    ...
    public function destroy($id)
    {
        ...
        // ✅ ADMIN BISA HAPUS SEMUA PERHITUNGAN
        // Tidak perlu cek ownership karena ini admin controller
    ...
    public function cetak($id)
    {
        ...
        // dd($perhitungan->toArray()); // Uncomment untuk debug

        return view('admin.perhitungan.cetak', [
